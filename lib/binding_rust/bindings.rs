...
extern "C" {
    ...
    pub fn ts_node_type(arg1: *const TSNode) -> *const ::std::os::raw::c_char;
}
extern "C" {
    #[doc = " Get the node\'s type as a numerical id."]
    pub fn ts_node_symbol(arg1: *const TSNode) -> TSSymbol;
}
extern "C" {
    #[doc = " Get the node\'s start byte."]
    pub fn ts_node_start_byte(arg1: *const TSNode) -> u32;
}
extern "C" {
    #[doc = " Get the node\'s start position in terms of rows and columns."]
    pub fn ts_node_start_point(arg1: *const TSNode) -> TSPoint;
}
extern "C" {
    #[doc = " Get the node\'s end byte."]
    pub fn ts_node_end_byte(arg1: *const TSNode) -> u32;
}
extern "C" {
    #[doc = " Get the node\'s end position in terms of rows and columns."]
    pub fn ts_node_end_point(arg1: *const TSNode) -> TSPoint;
}
extern "C" {
    ...
    pub fn ts_node_string(arg1: *const TSNode) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    ...
    #[doc = " was found."]
    pub fn ts_node_is_null(arg1: *const TSNode) -> bool;
}
extern "C" {
    ...
    #[doc = " grammar."]
    pub fn ts_node_is_named(arg1: *const TSNode) -> bool;
}
extern "C" {
    ...
    pub fn ts_node_is_missing(arg1: *const TSNode) -> bool;
}
extern "C" {
    #[doc = " Check if the node is *missing*. Missing nodes are inserted by the parser in"]
    #[doc = " order to recover from certain kinds of syntax errors."]
    pub fn ts_node_is_extra(arg1: *const TSNode) -> bool;
}
extern "C" {
    #[doc = " Check if a syntax node has been edited."]
    pub fn ts_node_has_changes(arg1: *const TSNode) -> bool;
}
extern "C" {
    #[doc = " Check if the node is a syntax error or contains any syntax errors."]
    pub fn ts_node_has_error(arg1: *const TSNode) -> bool;
}
extern "C" {
    #[doc = " Get the node\'s immediate parent."]
    pub fn ts_node_parent(arg1: *const TSNode) -> TSNode;
}
extern "C" {
    #[doc = " Get the node\'s child at the given index, where zero represents the first"]
    #[doc = " child."]
    pub fn ts_node_child(arg1: *const TSNode, arg2: u32) -> TSNode;
}
extern "C" {
    #[doc = " Get the node\'s number of children."]
    pub fn ts_node_child_count(arg1: *const TSNode) -> u32;
}
extern "C" {
    #[doc = " Get the node\'s *named* child at the given index."]
    #[doc = ""]
    #[doc = " See also `ts_node_is_named`."]
    pub fn ts_node_named_child(arg1: *const TSNode, arg2: u32) -> TSNode;
}
extern "C" {
    #[doc = " Get the node\'s number of *named* children."]
    #[doc = ""]
    #[doc = " See also `ts_node_is_named`."]
    pub fn ts_node_named_child_count(arg1: *const TSNode) -> u32;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_node_child_by_field_id(arg1: *const TSNode, arg2: TSFieldId) -> TSNode;
}
extern "C" {
    #[doc = " Get the node\'s next / previous sibling."]
    pub fn ts_node_next_sibling(arg1: *const TSNode) -> TSNode;
}
extern "C" {
    pub fn ts_node_prev_sibling(arg1: *const TSNode) -> TSNode;
}
extern "C" {
    #[doc = " Get the node\'s next / previous *named* sibling."]
    pub fn ts_node_next_named_sibling(arg1: *const TSNode) -> TSNode;
}
extern "C" {
    pub fn ts_node_prev_named_sibling(arg1: *const TSNode) -> TSNode;
}
extern "C" {
    #[doc = " Get the node\'s first child that extends beyond the given byte offset."]
    pub fn ts_node_first_child_for_byte(arg1: *const TSNode, arg2: u32) -> TSNode;
}
extern "C" {
    #[doc = " Get the node\'s first named child that extends beyond the given byte offset."]
    pub fn ts_node_first_named_child_for_byte(arg1: *const TSNode, arg2: u32) -> TSNode;
}
extern "C" {
    #[doc = " Get the smallest node within this node that spans the given range of bytes"]
    #[doc = " or (row, column) positions."]
    pub fn ts_node_descendant_for_byte_range(arg1: *const TSNode, arg2: u32, arg3: u32) -> TSNode;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_node_named_descendant_for_byte_range(
        arg1: *const TSNode,
        arg2: u32,
        arg3: u32,
    ) -> TSNode;
...
extern "C" {
    ...
    pub fn ts_node_eq(arg1: *const TSNode, arg2: *const TSNode) -> bool;
}
extern "C" {
    ...
    pub fn ts_tree_cursor_new(arg1: *const TSNode) -> TSTreeCursor;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_tree_cursor_reset(arg1: *mut TSTreeCursor, arg2: *const TSNode);
}
extern "C" {
